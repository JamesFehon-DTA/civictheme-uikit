...
A compact list of navigational links with optional descriptions and directional icons.
...
<Canvas of={Stories.FeatureLinkListNoDescription} />
...
<Canvas of={Stories.SuggestedPrompts} />
...
- **Promo** – use to highlight a single featured item with an image and call to action.
- **Manual list** – use for simpler link lists that do not require descriptions or hover icons.
- **Callout** – use within rich text to draw attention to a single important link or requirement.
